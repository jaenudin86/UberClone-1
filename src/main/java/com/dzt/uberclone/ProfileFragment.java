...
public class ProfileFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name.setText(sp.getString("name","No name"));
        lastname.setText(sp.getString("last name","No last name"));
        email.setText(sp.getString("email", "No email"));
        telephone.setText(sp.getString("phone", "No phone"));
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.profile_account_work:
                ...
                fragmentManager.beginTransaction()
                        .replace(R.id.container, fragment).addToBackStack("addwork")
                        .commit();
                break;
